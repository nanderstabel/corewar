...
Test(test_lexical_analysis, valid_asm_42_test)
{
	...
	as->fd = open("test_folder/asm_test_folder/valid_s_files/42.s", O_RDONLY);
	ret = analyze_lexicon(as);
	cr_assert(ret == SUCCESS);
}
...
Test(test_lexical_analysis, newline_strings_test)
{
	...
	as->fd = open("test_folder/asm_test_folder/valid_s_files/newline_string.s", O_RDONLY);
	ret = analyze_lexicon(as);
	cr_assert(ret == SUCCESS);
}
...
Test(test_lexical_analysis, lexical_error_small, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_small.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_01, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_01.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_02, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_02.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_03, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_03.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_04, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_04.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_05, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_05.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_06, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_06.s", O_RDONLY);
	analyze_lexicon(as);
...
Test(test_lexical_analysis, lexical_error_07, .init=redirect_all_stdout_lexical)
{
	...
	as->fd = open("test_folder/asm_test_folder/invalid_s_files/lexical_error_07.s", O_RDONLY);
	analyze_lexicon(as);
