...
#    Updated: 2020/05/14 22:43:10 by nstabel       ########   odam.nl          #
#                                                                              #
# **************************************************************************** #

FILES := ft_putchar.c ft_putchar_fd.c \
	ft_putstr.c ft_putstr_fd.c ft_putnstr_fd.c \
	...
	ft_lstfold.c \
	ft_lstcount.c \
	ft_lstadd_behind.c ft_lstadd_before.c \
	ft_absolute.c \
	ft_absolute_nbrlen.c ft_absolute_doublelen.c \
	ft_power.c ft_double_power.c \
	get_next_line.c \
	...
	ft_strequ_till_whitespaces.c ft_lstnew_ptr.c ft_nchar.c ft_strndup.c \
	ft_lst_last_elem.c get_next_newline.c
