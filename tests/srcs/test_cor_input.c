...
Test(input_validation, invalid_n_option_four_players_1, .init=redirect_all_stdout)
{
	...
	given_argv[6] = ft_strdup("tests/testfiles/valid/helltrain.cor");
	given_argv[7] = ft_strdup("-n");
	given_argv[8] = ft_strdup("2");
	given_argv[9] = ft_strdup("tests/testfiles/valid/bigzork.cor");
	given_argv[10] = ft_strdup("-n");
	given_argv[11] = ft_strdup("3");
	given_argv[12] = ft_strdup("tests/testfiles/valid/bee_gees.cor");
...
Test(input_validation, valid_d_and_n_option_four_players)
{
	...
	given_argv[5] = ft_strdup("tests/testfiles/valid/fluttershy.cor");
	given_argv[6] = ft_strdup("-n");
	given_argv[7] = ft_strdup("1");
	given_argv[8] = ft_strdup("tests/testfiles/valid/helltrain.cor");
	given_argv[9] = ft_strdup("-n");
	given_argv[10] = ft_strdup("2");
	given_argv[11] = ft_strdup("tests/testfiles/valid/bigzork.cor");
	given_argv[12] = ft_strdup("-n");
	given_argv[13] = ft_strdup("3");
	given_argv[14] = ft_strdup("tests/testfiles/valid/bee_gees.cor");
...
Test(input_validation, valid_three_players)
{
	...
	cr_expect_eq(vm.champ[3]->header.prog_size, 23, "zork should be 23 bytes heavy, not %d", vm.champ[3]->header.prog_size);
	free_vm(&vm, SUCCESS);
}
