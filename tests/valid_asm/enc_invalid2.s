...
.comment "I'M ALIIIIVE"
	...
	ld %145162240, r2	#load bytes that translate to: 06 a7 00 00 into r2   --> 08 is 'and' operation. a7 == 010100111 encoding byte which is INVALID (DIR, DIR, REG, 11). It will trigger the cursor to skip 11 bytes
